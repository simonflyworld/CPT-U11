# -*- coding: utf-8 -*-
"""
Created on Mon Dec 17 19:03:08 2018
...
def take_picture(camra_choose):
    ...
    cam_input =cv2.VideoCapture(camra_choose) 
...
def identification():
    ...
    letter_in_image = pytesseract.image_to_string(Image.open('math.jpg'))
...
def main():
    ...
    while True:
        try:
            camra_choose = int(input("camra choose"))
        except:
            print("input should be a number,this number is the camra part number on your computer.")
        else:
            take_picture(camra_choose)
            break
    ...
    print(count_main(letter_in_image))
